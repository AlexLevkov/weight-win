      ...
      <div id="" className="w-20" style={{ width: "400px" }}>
        <form className="w-20" onSubmit={handleSubmit}>
          <div className="form-group m-1">
            <label className="mb-1" htmlFor="weight-input">
          ...
          <div className="form-group m-1">
            <label className="mb-1" htmlFor="walk-input">
              How much time did you exercise?
            </label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="form-group form-check m-1">
            ...
            <label className="form-check-label" htmlFor="exampleCheck1">
              I drank two litters of water
            </label>
          </div>
          <button type="submit" className="btn btn-app my-2">
            Submit
          </button>
        </form>
        <div
